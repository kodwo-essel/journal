/*
  ...
  Insert the education system blog post into the existing blog_posts table
*/
...
INSERT INTO blog_posts (
  ...
  'Why our schools are teaching yesterday''s skills for tomorrow''s world, and what we can do about it.',
...
I studied something that was very respected at the time. And yes, I worked in that field. But I looked around at what was happening. I learned other things. I paid attention. And I moved into something else. And that was fine. What saved me was being willing to change. Being willing to learn. Being willing to look at the world and say okay, what actually makes sense right now?
